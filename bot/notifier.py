...
async def send_reminder(bot: Bot, channel_id: str, event: WeddingEvent, reminder_minutes: int) -> None:
    try:
        await send_html_message(bot, channel_id, format_reminder(event, reminder_minutes))
